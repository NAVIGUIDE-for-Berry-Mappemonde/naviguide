...
<<<<<<< HEAD
=======
🏆 **Hackathon Amazon Nova AI** — Nova 2 Lite primary, Claude fallback.
...
=======
- **AI expedition briefing** generated by Amazon Nova 2 Lite (+ Claude fallback) via a multi-agent pipeline (~26 sec)
>>>>>>> f4d5b955cff48fe4171a3ea152d75be0dbcc5213
...
=======
│ Agent 1 — Route Intelligence │  AWS Bedrock — Nova 2 Lite (Claude fallback)
>>>>>>> f4d5b955cff48fe4171a3ea152d75be0dbcc5213
...
=======
│ Agent 3 — Risk Assessment    │  AWS Bedrock — Nova 2 Lite (Claude fallback)
>>>>>>> f4d5b955cff48fe4171a3ea152d75be0dbcc5213
...
=======
│ Briefing — Executive Summary  │  Nova 2 Lite (Claude fallback)
>>>>>>> f4d5b955cff48fe4171a3ea152d75be0dbcc5213
...
=======
**Models:** `us.amazon.nova-2-lite-v1:0` primary, `us.anthropic.claude-3-5-sonnet-20241022-v2:0` fallback. Setup: [docs/SETUP_NOVA_CREDITS.md](docs/SETUP_NOVA_CREDITS.md). Dev plan: [docs/PLAN_DEV_NOVA.md](docs/PLAN_DEV_NOVA.md). Manuel: [docs/MANUAL.md](docs/MANUAL.md).
>>>>>>> f4d5b955cff48fe4171a3ea152d75be0dbcc5213
...
=======
- AWS credentials — for Bedrock (Nova 2 Lite + Claude fallback); optional, falls back gracefully to static analysis
>>>>>>> f4d5b955cff48fe4171a3ea152d75be0dbcc5213
...
GEMINI_API_KEY=AIza...
=======
# naviguide_workspace/.env (Bedrock — Nova + Claude)
...
=======
# 2. Set credentials and start supervisord (see docs/SETUP_NOVA_CREDITS.md)
# Load naviguide_workspace/.env or export AWS_* / AWS_BEARER_TOKEN_BEDROCK
supervisord -c supervisor/supervisord.conf
...
=======
| AI Orchestration | LangGraph, AWS Bedrock (Nova 2 Lite + Claude 3.5 Sonnet fallback) |
>>>>>>> f4d5b955cff48fe4171a3ea152d75be0dbcc5213
...
=======
- **AWS Bedrock** — Nova 2 Lite + Claude fallback require valid AWS credentials; falls back to static analysis text if unavailable. Smoke test: `python3 scripts/test_bedrock.py`
>>>>>>> f4d5b955cff48fe4171a3ea152d75be0dbcc5213
